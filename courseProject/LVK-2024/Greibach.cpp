...
namespace GRB
{
	Greibach greibach(NS('S'), TS(' '), 16,// TS('')
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 14, 14,																// Недопустимая синтаксическая конструкция
			Rule::Chain(7, TS('#'), TS('t'), TS('i'), TS('='), NS('V'), TS(';'), NS('K')),							// декларация + присваивание
			Rule::Chain(5, TS('#'), TS('t'), TS('i'), TS(';'), NS('K')),											// декларация
			...
			Rule::Chain(6, TS('#'), TS('t'), TS('i'), TS('='), NS('V'), TS(';')),									// декларация + присваивание
			Rule::Chain(4, TS('i'), TS('='), NS('W'), TS(';')),													// присваивание
			Rule::Chain(4, TS('#'), TS('t'), TS('i'), TS(';')),													// декларация
