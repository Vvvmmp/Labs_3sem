...
#define GRAPH_STRING_LITERAL 3,\
	...
	FST::NODE(87, \
			...
			FST::RELATION('A', 1), FST::RELATION('B', 1), FST::RELATION('C', 1), FST::RELATION('D', 1),\
			FST::RELATION('E', 1), FST::RELATION('F', 1), FST::RELATION('G', 1), FST::RELATION('H', 1),\
			FST::RELATION('I', 1), FST::RELATION('J', 1), FST::RELATION('K', 1), FST::RELATION('\'', 1),\
			FST::RELATION('M', 1), FST::RELATION('N', 1), FST::RELATION('O', 1), FST::RELATION('P', 1),\
			FST::RELATION('Q', 1), FST::RELATION('R', 1), FST::RELATION('S', 1), FST::RELATION('T', 1),\
			FST::RELATION('U', 1), FST::RELATION('V', 1), FST::RELATION('W', 1), FST::RELATION('X', 1),\
			FST::RELATION('Y', 1), FST::RELATION('Z', 1),\
...
#define GRAPH_NEWLINE 3, \
	FST::NODE(1, FST::RELATION('n',1)),\
	FST::NODE(1, FST::RELATION('l',2)),\
	FST::NODE()

#define GRAPH_FINISH 7, \
	FST::NODE(1, FST::RELATION('f',1)),\
...
#define GRAPH_V_LITERAL 4, \
	...
	\
    FST::NODE(16, FST::RELATION('0', 3), FST::RELATION('1', 3), FST::RELATION('2', 3), FST::RELATION('3', 3), FST::RELATION('4', 3), FST::RELATION('5', 3), FST::RELATION('6', 3), FST::RELATION('7', 3),\
...
#define GRAPH_HEX_LITERAL 5,	\
    FST::NODE(1, FST::RELATION('1', 1)),\
	FST::NODE(1, FST::RELATION('6', 2)),\
    FST::NODE(1, FST::RELATION('x', 3)),\
	\
	FST::NODE(32,FST::RELATION('0', 4), FST::RELATION('1', 4), FST::RELATION('2', 4), FST::RELATION('3', 4), FST::RELATION('4', 4), FST::RELATION('5', 4), FST::RELATION('6', 4), FST::RELATION('7', 4),\
				 FST::RELATION('8', 4), FST::RELATION('9', 4), FST::RELATION('a', 4), FST::RELATION('b', 4), FST::RELATION('c', 4), FST::RELATION('d', 4), FST::RELATION('e', 4), FST::RELATION('f', 4),\
				 \
				 ...
				 FST::RELATION('8', 3), FST::RELATION('9', 3), FST::RELATION('a', 3), FST::RELATION('b', 3), FST::RELATION('c', 3), FST::RELATION('d', 3), FST::RELATION('e', 3), FST::RELATION('f', 3)),\
    FST::NODE()
